...
public interface CustomerController {
    ...
    CustomerDTO createCustomer(CustomerCreationDTO customer, HttpServletRequest request) throws ImageStorageException;

    @PatchMapping(path = "/{customerId}")
    CustomerDTO updateCustomer(@PathVariable int customerId, CustomerCreationDTO customer, HttpServletRequest request)
